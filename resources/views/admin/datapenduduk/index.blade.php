            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="pendidikan" class="form-select" data-placeholder="Pilih agama">
                            <option></option>
                    ...
                    <div class="mb-10">
                        ...
                        <select name="status_hubungan" class="form-select" data-placeholder="Pilih status">
                            <option></option>
                    ...
                    <div class="mb-10">
                        ...
                        <select name="golongan_darah" class="form-select" data-placeholder="Pilih status">
                            <option></option>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Data Penduduk');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-data-penduduk', 'Tambah',
                    'Data Penduduk',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-data-penduduk/' + uuid,
                    'Update',
                    'Data Penduduk', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-data-penduduk/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Data Penduduk', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-data-penduduk/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data Penduduk" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                rowGroup: {
                    dataSrc: 'no_kk', // Ganti 'jenis_fasilitas_kesehatan' dengan nama kolom yang ingin digunakan sebagai grup
        ...
        $('#export-excel').click(function(e) {
            e.preventDefault();
            window.open(`/admin/export-data-penduduk`, "_blank");
        });
    </script>
@endsection
