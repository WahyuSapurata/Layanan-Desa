        ...
        <div class="card w-100">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        <label for="deskripsi" class="form-label">Isi Pengumuman</label>
                        <textarea id="isi" name="isi" class="form-control" data-kt-autosize="true"></textarea>
                        <small class="text-danger isi_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Tanggal Pelaksanaan</label>
                        <input type="text" id="tanggal_pelaksanaan" class="form-control" name="tanggal_pelaksanaan">
                        <small class="text-danger tanggal_pelaksanaan_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Pengumuman');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-pengumuman', 'Tambah',
                    'Pengumuman',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-pengumuman/' + uuid,
                    'Update',
                    'Pengumuman', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-pengumuman/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Pengumuman', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-pengumuman/' + $(this).attr('data-uuid');
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Pengumuman" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        //     e.preventDefault();
        //     window.open(`/admin/export-pengumuman`, "_blank");
        // });
    </script>
@endsection
