            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger no_surat_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Asal Surat</label>
                        <input type="text" id="asal_surat" class="form-control" name="asal_surat">
                        <small class="text-danger asal_surat_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Tanggal Surat</label>
                        <input type="text" id="tanggal_surat" class="form-control kt_datepicker_1" name="tanggal_surat">
                    ...
                    <div class="mb-10">
                        ...
                        <input class="form-control" accept="image/*" type="file" name="lampiran" id="lampiran">
                        <small class="text-danger lampiran_error"></small>
                    </div>

                    <div class="mb-10">
                        <label for="keterangan" class="form-label">Keterangan</label>
                        <textarea id="keterangan" name="keterangan" class="form-control" data-kt-autosize="true"></textarea>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Surat Masuk');
        });
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-suratmasuk', 'Tambah',
                    'Surat Masuk',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-suratmasuk/' + uuid,
                    'Update',
                    'Surat Masuk', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-suratmasuk/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Surat Masuk', url);
        });

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-suratmasuk/' + $(this).attr('data-uuid');
                ...
                columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        result =
                            `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/storage/lampiran/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/storage/lampiran/${data}')">
                                    </div>
                                    <!--end::Image-->
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                                ...
                                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Surat Masuk" class="btn btn-danger button-delete btn-icon btn-sm">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
