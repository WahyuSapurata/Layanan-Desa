...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; font-size: 15px;">Nomor : {{ $ketkematian->nomor_surat }}</div>
            <div style="width: 100%; margin-top: 50px; font-size: 16px">
                ...
                <table style="margin-left: 50px">
                    <tr>
                        <td>Nama Almarhum</td>
                        <td>:</td>
                        <td>{{ $ketkematian->nama }}</td>
                    </tr>
                    <tr>
                        <td>Tempat/Tgl Lahir</td>
                        <td>:</td>
                        <td>{{ $ketkematian->tempat_lahir . ', ' . $ketkematian->tanggal_lahir }}</td>
                    </tr>
                    <tr>
                        <td>Jenis Kelamin</td>
                        <td>:</td>
                        <td>{{ $ketkematian->jenis_kelamin }}</td>
                    </tr>
                    <tr>
                        <td>Status Perkawinan</td>
                        <td>:</td>
                        <td>{{ $ketkematian->status_perkawinan }}</td>
                    </tr>
                    <tr>
                        <td>Kewarganegaraan</td>
                        <td>:</td>
                        <td>{{ $ketkematian->kewarganegaran }}</td>
                    </tr>
                    <tr>
                        <td>Agama</td>
                        <td>:</td>
                        <td>{{ $ketkematian->agama }}</td>
                    </tr>
                    <tr>
                        <td>Pekerjaan</td>
                        <td>:</td>
                        <td>{{ $ketkematian->pekerjaan }}</td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>:</td>
                        <td>{{ $ketkematian->alamat }}</td>
                    </tr>
                </table>
                <div style="margin-top: 20px">Benar bahwa orang tersebut diatas berada di wilayah kami dan telah
                    Meninggal pada:</div>
                <table style="margin-left: 50px">
                    <tr>
                        <td>Hari</td>
                        <td>:</td>
                        <td>{{ $ketkematian->hari_meninggal }}</td>
                    </tr>
                    <tr>
                        <td>Tanggal</td>
                        <td>:</td>
                        <td>{{ $ketkematian->tanggal_meninggal }}</td>
                    </tr>
                    <tr>
                        <td>Pukul</td>
                        <td>:</td>
                        <td>{{ $ketkematian->jam_meninggal }} Wita</td>
                    </tr>
                    <tr>
                        <td>Tempat Pemakaman</td>
                        <td>:</td>
                        <td>{{ $ketkematian->tempat_pemakaman }}</td>
                    </tr>
                </table>
