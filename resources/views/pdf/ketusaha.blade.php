...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; font-size: 15px;">Nomor : {{ $ketusaha->nomor_surat }}</div>
            <div style="width: 100%; margin-top: 50px; font-size: 16px">
                ...
                <table style="margin-left: 50px">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $ketusaha->tempat_lahir . ', ' . $ketusaha->tanggal_lahir }}</td>
                    </tr>
                    <tr>
                        <td>Jenis Kelamin</td>
                        <td>:</td>
                        <td>{{ $ketusaha->jenis_kelamin }}</td>
                    </tr>
                    <tr>
                        <td>Status Perkawinan</td>
                        <td>:</td>
                        <td>{{ $ketusaha->status_perkawinan }}</td>
                    </tr>
                    <tr>
                        <td>Kewarganegaraan</td>
                        <td>:</td>
                        <td>{{ $ketusaha->kewarganegaraan }}</td>
                    </tr>
                    <tr>
                        <td>Agama</td>
                        <td>:</td>
                        <td>{{ $ketusaha->agama }}</td>
                    </tr>
                    <tr>
                        <td>Pekerjaan</td>
                        <td>:</td>
                        <td>{{ $ketusaha->pekerjaan }}</td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>:</td>
                        <td>{{ $ketusaha->alamat }}</td>
                    </tr>
                </table>

                <p style="margin-top: 10px; text-indent: 50px;">Benar bahwa orang tersebut diatas adalah warga kami yang
                    bertempat tinggal
                    sesuai alamat tersebut dan
                    selama ini mejalankan usaha, di Bidang <span
                        style="font-weight: bold">{{ $ketusaha->deskripsi }}</span> sampai sekarang.</p>
                <p style="margin-top: 20px; text-indent: 50px;">Demikian surat keterangan ini kami berikan kepadanya
                    untuk di pergunakan
